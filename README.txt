...
usage: <./program name> -i <input file> [ <input file> <input file> ..]
			[ [-c] <configuration file> [-o] <output file name> ]
...
central station, intercity station, or stad station.
transportation type are one of the following:
bus, tram, sprinter or rail.
